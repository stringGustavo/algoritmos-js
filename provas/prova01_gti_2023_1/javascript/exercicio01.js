...
function calcular () {
    ...
    if(primeiroNumero > 0 && segundoNumero > 0) {
        ...
        div.innerHTML += `<p>A raiz quadrada dos números são: ${raizQuadradaPrimeiroNumero.toFixed(2)} e ${raizQuadradaSegundoNumero.toFixed(2)}</p>`;
        div.innerHTML += `<p>A raiz cúbica dos números são: ${raizCubicaPrimeiroNumero.toFixed(2)} e ${raizCubicaSegundoNumero.toFixed(2)}</p>`;
        div.innerHTML += `<p>A raiz sétima dos números são: ${raizSetimaPrimeiroNumero.toFixed(2)} e ${raizSetimaSegundoNumero.toFixed(2)}</p>`;
    } else {
